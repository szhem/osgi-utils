...
public final class Filters {
     ...
     * @param attr the name of attribute
     * @param val the value to check the attribute against
     * @param mode the {@link com.github.szhem.osgi.util.filter.LikeCriterion.MatchMode} to be used
     *
    ...
    /**
     * Creates the criterion that represents that uses {@link com.github.szhem.osgi.util.filter.LikeCriterion.MatchMode#EXACT}
     * to match the specified attribute to the specified value.
     *
     * @param attr the name of attribute
     * @param val the value to check the attribute against
     *
     * @return the criterion that represents that uses {@link com.github.szhem.osgi.util.filter.LikeCriterion.MatchMode#EXACT}
     * to match the specified attribute to the specified value
     */
